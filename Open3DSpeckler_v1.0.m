...
function alignPoints4()
    ...
    % For 2D Alignment %
    if (size(finalFit488,2) == gauss2DN) && (size(finalFit594,2) == gauss2DN) && (size(finalFit640,2) == gauss2DN) && (size(finalFit405,2) == gauss2DN)
    ...
    % For 3D Alignment %
    elseif (size(finalFit488,2) == gauss3DN) && (size(finalFit594,2) == gauss3DN) && (size(finalFit640,2) == gauss3DN) && (size(finalFit405,2) == gauss3DN)
...
function alignPoints3()
    ...
    % For 2D Alignment %
    if (sizeCheck(1) == gauss2DN) && (sizeCheck(2) == gauss2DN) && (sizeCheck(3) == gauss2DN)
    ...
    % For 3D Alignment %
    elseif (sizeCheck(1) == gauss3DN) && (sizeCheck(2) == gauss3DN) && (sizeCheck(3) == gauss3DN)
...
function alignPoints2()
    ...
    % For 2D Alignment %
    if (sizeCheck(1) == gauss2DN) && (sizeCheck(2) == gauss2DN)
    ...
    % For 3D Alignment %
    elseif (sizeCheck(1) == gauss3DN) && (sizeCheck(2) == gauss3DN)
...
function generateDistanceMatrices()
    ...
    if distChoiceVec(4) == 1
        if size(finalFit405,2) == gauss2DN
    ...
    if (distChoiceVec(1) == 1) && (distChoiceVec(2) == 1)
        if (size(finalFit488,2) == gauss2DN) && (size(finalFit594,2) == gauss2DN)
            distMatrix488_594 = distanceMatrix(finalFit488(:,1:2), finalFit594(:,1:2));
        elseif (size(finalFit488,2) == gauss3DN) && (size(finalFit594,2) == gauss3DN)
    ...
    if (distChoiceVec(1) == 1) && (distChoiceVec(4) == 1)
        if (size(finalFit488,2) == gauss2DN) && (size(finalFit405,2) == gauss2DN)
            distMatrix488_405 = distanceMatrix(finalFit488(:,1:2), finalFit405(:,1:2));
        elseif (size(finalFit488,2) == gauss3DN) && (size(finalFit405,2) == gauss3DN)
    ...
    if (distChoiceVec(2) == 1) && (distChoiceVec(3) == 1)
        if (size(finalFit594,2) == gauss2DN) && (size(finalFit640,2) == gauss2DN)
            distMatrix594_640 = distanceMatrix(finalFit594(:,1:2), finalFit640(:,1:2));
        elseif (size(finalFit594,2) == gauss3DN) && (size(finalFit640,2) == gauss3DN)
    ...
    if (distChoiceVec(2) == 1) && (distChoiceVec(4) == 1)
        if (size(finalFit594,2) == gauss2DN) && (size(finalFit405,2) == gauss2DN)
            distMatrix594_405 = distanceMatrix(finalFit594(:,1:2), finalFit405(:,1:2));
        elseif (size(finalFit594,2) == gauss3DN) && (size(finalFit405,2) == gauss3DN)
    ...
    if (distChoiceVec(3) == 1) && (distChoiceVec(4) == 1)
        if (size(finalFit640,2) == gauss2DN) && (size(finalFit405,2) == gauss2DN)
            distMatrix640_405 = distanceMatrix(finalFit640(:,1:2), finalFit405(:,1:2));
        elseif (size(finalFit640,2) == gauss3DN) && (size(finalFit405,2) == gauss3DN)
